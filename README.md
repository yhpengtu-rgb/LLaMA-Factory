1. Enviroments
   Firstly, you can follow LLaMA-Factory to prepared your python enviroment, and and following package information are my used:
  ...
  av=15.1.0=pypi_0
  bitsandbytes=0.47.0=pypi_0
  blake3=1.0.6=pypi_0
  brotli=1.1.0=pypi_0
  bzip2=1.0.8=h5eee18b_6
  ca-certificates=2025.9.9=h06a4308_0
  cachetools=6.2.0=pypi_0
  cbor2=5.7.0=pypi_0
  certifi=2025.8.3=pypi_0
  cffi=2.0.0=pypi_0
  charset-normalizer=3.4.3=pypi_0
  click=8.3.0=pypi_0
  cloudpickle=3.1.1=pypi_0
  compressed-tensors=0.10.2=pypi_0
  contourpy=1.3.2=pypi_0
  cupy-cuda12x=13.6.0=pypi_0
  cut-cross-entropy=25.1.1=pypi_0
  cycler=0.12.1=pypi_0
  datasets=3.6.0=pypi_0
  decorator=5.2.1=pypi_0
  depyf=0.19.0=pypi_0
  diffusers=0.35.1=pypi_0
  dill=0.3.8=pypi_0
  diskcache=5.6.3=pypi_0
  distro=1.9.0=pypi_0
  dnspython=2.8.0=pypi_0
  docstring-parser=0.17.0=pypi_0
  einops=0.8.1=pypi_0
  email-validator=2.3.0=pypi_0
  exceptiongroup=1.3.0=pypi_0
  expat=2.7.1=h6a678d5_0
  fastapi=0.117.1=pypi_0
  fastapi-cli=0.0.13=pypi_0
  fastapi-cloud-cli=0.2.1=pypi_0
  fastrlock=0.8.3=pypi_0
  ffmpy=0.6.1=pypi_0
  filelock=3.19.1=pypi_0
  fire=0.7.1=pypi_0
  fonttools=4.60.0=pypi_0
  frozendict=2.4.6=pypi_0
  frozenlist=1.7.0=pypi_0
  fsspec=2024.6.1=pypi_0
  gguf=0.17.1=pypi_0
  gradio=5.45.0=pypi_0
  gradio-client=1.13.0=pypi_0
  groovy=0.1.2=pypi_0
  h11=0.16.0=pypi_0
  hf-transfer=0.1.9=pypi_0
  hf-xet=1.1.10=pypi_0
  httpcore=1.0.9=pypi_0
  httptools=0.6.4=pypi_0
  httpx=0.28.1=pypi_0
  huggingface-hub=0.35.1=pypi_0
  idna=3.10=pypi_0
  ...
  jiter=0.11.0=pypi_0
  joblib=1.5.2=pypi_0
  jsonschema=4.25.1=pypi_0
  jsonschema-specifications=2025.9.1=pypi_0
  kiwisolver=1.4.9=pypi_0
  lark=1.2.2=pypi_0
  ...
  librosa=0.11.0=pypi_0
  libstdcxx-ng=11.2.0=h1234567_1
  libuuid=1.41.5=h5eee18b_0
  libxcb=1.17.0=h9b100fa_0
  libzlib=1.3.1=hb25bd0a_0
  llamafactory=0.9.4.dev0=pypi_0
  llguidance=0.7.30=pypi_0
  llvmlite=0.44.0=pypi_0
  lm-format-enforcer=0.10.12=pypi_0
  markdown-it-py=4.0.0=pypi_0
  markupsafe=2.1.5=pypi_0
  matplotlib=3.10.6=pypi_0
  mdurl=0.1.2=pypi_0
  mistral-common=1.8.5=pypi_0
  modelscope=1.30.0=pypi_0
  mpmath=1.3.0=pypi_0
  msgpack=1.1.1=pypi_0
  msgspec=0.19.0=pypi_0
  multidict=6.6.4=pypi_0
  ...
  openai=1.90.0=pypi_0
  openai-harmony=0.0.4=pypi_0
  opencv-python-headless=4.12.0.88=pypi_0
  openssl=3.0.17=h5eee18b_0
  orjson=3.11.3=pypi_0
  outlines-core=0.2.10=pypi_0
  packaging=25.0=pypi_0
  pandas=2.3.2=pypi_0
  partial-json-parser=0.2.1.1.post6=pypi_0
  peft=0.17.1=pypi_0
  pillow=11.0.0=pypi_0
  pip=25.2=pyhc872135_0
  platformdirs=4.4.0=pypi_0
  pooch=1.8.2=pypi_0
  prometheus-client=0.23.1=pypi_0
  prometheus-fastapi-instrumentator=7.1.0=pypi_0
  propcache=0.3.2=pypi_0
  protobuf=3.20.3=pypi_0
  psutil=7.1.0=pypi_0
  pthread-stubs=0.3=h0ce48e5_1
  py-cpuinfo=9.0.0=pypi_0
  pyarrow=21.0.0=pypi_0
  pybase64=1.4.2=pypi_0
  pycountry=24.6.1=pypi_0
  pycparser=2.23=pypi_0
  pydantic=2.10.6=pypi_0
  pydantic-core=2.27.2=pypi_0
  pydantic-extra-types=2.10.5=pypi_0
  pydub=0.25.1=pypi_0
  pygments=2.19.2=pypi_0
  pyparsing=3.2.5=pypi_0
  python=3.10.18=h1a3bd86_0
  python-dateutil=2.9.0.post0=pypi_0
  python-dotenv=1.1.1=pypi_0
  python-json-logger=3.3.0=pypi_0
  ...
  regex=2025.9.18=pypi_0
  requests=2.32.5=pypi_0
  rich=14.1.0=pypi_0
  rich-toolkit=0.15.1=pypi_0
  rignore=0.6.4=pypi_0
  rouge-chinese=1.0.3=pypi_0
  rpds-py=0.27.1=pypi_0
  ruff=0.13.1=pypi_0
  safehttpx=0.1.6=pypi_0
  safetensors=0.5.3=pypi_0
  scikit-learn=1.7.2=pypi_0
  scipy=1.15.3=pypi_0
  semantic-version=2.10.0=pypi_0
  sentencepiece=0.2.1=pypi_0
  sentry-sdk=2.39.0=pypi_0
  setproctitle=1.3.7=pypi_0
  ...
  sse-starlette=3.0.2=pypi_0
  starlette=0.48.0=pypi_0
  sympy=1.14.0=pypi_0
  termcolor=3.1.0=pypi_0
  threadpoolctl=3.6.0=pypi_0
  tiktoken=0.11.0=pypi_0
  tk=8.6.15=h54e0aa7_0
  tokenizers=0.21.4=pypi_0
  tomlkit=0.13.3=pypi_0
  torch=2.7.1=pypi_0
  torchao=0.13.0=pypi_0
  torchaudio=2.7.1=pypi_0
  torchvision=0.22.1=pypi_0
  tqdm=4.67.1=pypi_0
  transformers=4.55.4=pypi_0
  triton=3.3.1=pypi_0
  trl=0.9.6=pypi_0
  typer=0.19.2=pypi_0
  ...
  unsloth=2025.10.11=pypi_0
  unsloth-zoo=2025.10.12=pypi_0
  urllib3=2.5.0=pypi_0
  uvicorn=0.37.0=pypi_0
  uvloop=0.21.0=pypi_0
  vllm=0.10.0=pypi_0
  watchfiles=1.1.0=pypi_0
  websockets=15.0.1=pypi_0
  wheel=0.45.1=py310h06a4308_0
  xformers=0.0.31=pypi_0
  xgrammar=0.1.21=pypi_0
...
2. Trained checkpoint of llama3-8b on 100 proteins:
